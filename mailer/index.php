...
<body>
    <form method="POST" id="form">
        <div class="container" style="width: 60%">
            <div class="p-3 mb-2 mt-5 bg-primary text-white rounded">
            ...
            <button type="button" id="sendMail" class="btn btn-primary mt-3">Отправить</button>
            <div id="errorMes"></div>
    ...
    <div id="form2" class="bg-primary text-white rounded p-5" style="position: fixed;top: 0%; visibility: hidden;width: 100%; height: 100%;">
        <h>ФИО</h>
        <p id="fullname"></p>
        <h>Телефон</h>
        <p id="phone"></p>
